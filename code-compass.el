...
(defconst code-compass-path-to-code-compass (file-name-directory load-file-name) "Path to code compass.")
...
(defcustom code-compass-tmp-directory "/tmp" "Directory to store temporary files generated by code-compass.")

(defcustom code-compass-docker-data-directory "/data" "Directory to store temporary files generated by code-compass.")

(defcustom code-compass-download-directory (code-compass--expand-file-name "dependencies") "Directory to store downloaded dependencies.")
...
(defun code-compass--generate-list-authors-colors (repository)
  ...
  (--> (code-compass--get-authors repository)
       ...
       (code-compass--insert-authors-colors-in-file it repository))
  repository)
...
(defun code-compass--get-repositories-from-file (file)
  "Extract the list of directories on which to run `code-compass-show-hotspot-cluster-sync' from FILE."
